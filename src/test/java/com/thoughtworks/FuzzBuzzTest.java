...
public class FuzzBuzzTest {
    ...
    @Test
    void should_return_Buzz_given_input_contains_5_and_is_divisible_by_3_and_5() {
        FuzzBuzz fuzzBuzz = new FuzzBuzz();
    ...
    void should_return_Fizz_given_input_contains_7_and_5_and_is_divisible_by_3() {
        FuzzBuzz fuzzBuzz = new FuzzBuzz();
        assertEquals("Fizz", fuzzBuzz.report(753));
    }

    @Test
    void should_return_Fizz_given_input_contains_7_and_5_and_3_and_is_divisible_by_5() {
        FuzzBuzz fuzzBuzz = new FuzzBuzz();
        assertEquals("Fizz", fuzzBuzz.report(375));
    }
}
